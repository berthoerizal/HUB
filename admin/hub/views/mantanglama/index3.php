...
<label class="section-title">Desa Mantang Lama</label> 
 ...
 $kodeHTML = bacaHTML('http://mantanglama.simdes-bintan.id/index.php/first/statistik/0'); //statisik di ganti dengan nama desa
 ...
 $kodeHTML = empat('http://mantanglama.simdes-bintan.id/index.php/first/statistik/0'); //statistik di ganti dengan nama desa
