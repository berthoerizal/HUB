...
<label class="section-title">Desa Mantang Lama</label>
 ...
 $kodeHTML = bacaHTML('http://mantanglama.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://mantanglama.simdes-bintan.id/index.php/first/statistik/502');
