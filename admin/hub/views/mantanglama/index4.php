...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://mantanglama.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://mantanglama.simdes-bintan.id/index.php/first/statistik/14/0');
