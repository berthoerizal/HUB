...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pengikik.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://pengikik.simdes-bintan.id/index.php/first/statistik/14/0');
