...
<label class="section-title">Desa Pengikik</label>
 ...
 $kodeHTML = bacaHTML('http://pengikik.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://pengikik.simdes-bintan.id/index.php/first/statistik/501');
