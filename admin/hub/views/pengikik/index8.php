...
$kodeHTML = bacaHTML('http://pengikik.simdes-bintan.id/index.php/first/statistik/13');
...
$kodeHTML = empat('http://pengikik.simdes-bintan.id/index.php/first/statistik/13');
