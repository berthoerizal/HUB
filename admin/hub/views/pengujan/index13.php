...
<label class="section-title">Desa Pengujan</label>
 ...
 $kodeHTML = bacaHTML('http://pengujan.simdes-bintan.id/index.php/first/statistik/505');
 ...
 $kodeHTML = empat('http://pengujan.simdes-bintan.id/index.php/first/statistik/505');
