...
<label class="section-title">Desa Pengujan</label>
 ...
 $kodeHTML = bacaHTML('http://pengujan.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://pengujan.simdes-bintan.id/index.php/first/statistik/502');
