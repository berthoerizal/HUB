...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pengujan.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://pengujan.simdes-bintan.id/index.php/first/statistik/14/0');
