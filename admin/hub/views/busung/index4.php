...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://busung.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://busung.simdes-bintan.id/index.php/first/statistik/14/0');
