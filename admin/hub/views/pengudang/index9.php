...
<label class="section-title">Desa Pengudang</label>
 ...
 $kodeHTML = bacaHTML('http://pengudang.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://pengudang.simdes-bintan.id/index.php/first/statistik/501');
