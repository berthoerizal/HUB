...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pengudang.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://pengudang.simdes-bintan.id/index.php/first/statistik/14/0');
