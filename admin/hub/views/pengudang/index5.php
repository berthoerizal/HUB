...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pengudang.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://pengudang.simdes-bintan.id/index.php/first/statistik/1');
