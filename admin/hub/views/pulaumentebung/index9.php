<?php
              ...
              include "model/kecamatan/tambelan/index9.php";
          ?>
...
<label class="section-title">Desa Pulau Mentebung</label>
 ...
 $kodeHTML = bacaHTML('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/501');
