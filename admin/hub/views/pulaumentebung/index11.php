...
<label class="section-title">Desa Pulau Mentebung</label>
 ...
 $kodeHTML = bacaHTML('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/503');
