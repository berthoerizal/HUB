<?php
              ...
              include "model/kecamatan/tambelan/index10.php";
          ?>
...
<label class="section-title">Desa Pulau Mentebung</label>
 ...
 $kodeHTML = bacaHTML('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/502');
