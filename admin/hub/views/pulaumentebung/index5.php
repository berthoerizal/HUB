...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://pulaumentebung.simdes-bintan.id/index.php/first/statistik/1');
