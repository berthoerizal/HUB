...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/14/0');
