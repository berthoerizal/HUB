...
<label class="section-title">Desa Pulau Pinang</label>
 ...
 $kodeHTML = bacaHTML('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/504');
