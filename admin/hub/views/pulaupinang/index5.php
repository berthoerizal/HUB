...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://pulaupinang.simdes-bintan.id/index.php/first/statistik/1');
