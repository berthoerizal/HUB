          ...
          <?php
              ...
              include "model/kecamatan/serikualalobam/index4.php";
          ?>
 ...
 $kodeHTML = bacaHTML('http://kualasempang.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://kualasempang.simdes-bintan.id/index.php/first/statistik/14/0');
