...
<div class="row">
 ...
 $kodeHTML = bacaHTML('http://kualasempang.simdes-bintan.id/index.php/first/statistik/0');
 ...
 $kodeHTML = empat('http://kualasempang.simdes-bintan.id/index.php/first/statistik/0');
