          ...
          <?php
              ...
              include "model/kecamatan/serikualalobam/index12.php";
          ?>
...
<label class="section-title">Desa Kuala Sempang</label>
 ...
 $kodeHTML = bacaHTML('http://kualasempang.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://kualasempang.simdes-bintan.id/index.php/first/statistik/504');
