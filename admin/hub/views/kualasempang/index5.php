          ...
          <?php
              ...
              include "model/kecamatan/serikualalobam/index5.php";
          ?>
 ...
 $kodeHTML = bacaHTML('http://kualasempang.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://kualasempang.simdes-bintan.id/index.php/first/statistik/1');
