          ...
          <?php
              ...
              include "model/kecamatan/serikualalobam/index9.php";
          ?>
...
<label class="section-title">Desa Kuala Sempang</label>
 ...
 $kodeHTML = bacaHTML('http://kualasempang.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://kualasempang.simdes-bintan.id/index.php/first/statistik/501');
