...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://penaga.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://penaga.simdes-bintan.id/index.php/first/statistik/14/0');
