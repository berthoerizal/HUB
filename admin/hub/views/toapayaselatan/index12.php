<?php
              ...
              include "model/kecamatan/toapaya/index12.php";
          ?>
...
<label class="section-title">Desa Toapaya Selatan</label>
 ...
 $kodeHTML = bacaHTML('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/504');
