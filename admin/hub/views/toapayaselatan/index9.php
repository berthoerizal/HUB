...
<label class="section-title">Desa Toapaya Selatan</label>
 ...
 $kodeHTML = bacaHTML('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/501');
