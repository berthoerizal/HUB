<?php
              ...
              include "model/kecamatan/toapaya/index10.php";
          ?>
...
<label class="section-title">Desa Toapaya Selatan</label>
 ...
 $kodeHTML = bacaHTML('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://toapayaselatan.simdes-bintan.id/index.php/first/statistik/502');
