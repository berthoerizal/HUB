<?php
              ...
              include "model/kecamatan/teloksebong/index6.php";
          ?>
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/3');
