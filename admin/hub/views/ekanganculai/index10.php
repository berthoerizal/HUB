...
<label class="section-title">Desa Ekang Anculai</label>
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/502');
