<?php
              ...
              include "model/kecamatan/teloksebong/index5.php";
          ?>
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/1');
