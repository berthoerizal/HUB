<?php
              ...
              include "model/kecamatan/teloksebong/index9.php";
          ?>
...
<label class="section-title">Desa Ekang Anculai</label>
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/501');
