      <?php
              ...
              include "model/kecamatan/teloksebong/index4.php";
          ?>
...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/14/0');
