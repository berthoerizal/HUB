<?php
              ...
              include "model/kecamatan/teloksebong/index11.php";
          ?>
<!-- data penerima PKH-->
...
<label class="section-title">Desa Ekang Anculai</label>
 ...
 $kodeHTML = bacaHTML('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://ekanganculai.simdes-bintan.id/index.php/first/statistik/503');
