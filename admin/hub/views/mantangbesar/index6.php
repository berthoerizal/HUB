<?php
              ...
              include "model/kecamatan/mantang/index6.php";
          ?>
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/3');
