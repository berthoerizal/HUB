<?php
              ...
              include "model/kecamatan/mantang/index11.php";
          ?>
<!-- data penerima PKH-->
...
<label class="section-title">Desa Mantang Besar</label>
 ...
 $kodeHTML = bacaHTML('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/503');
