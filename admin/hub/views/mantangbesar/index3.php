...
<label class="section-title">Desa Mantang Besar</label> 
 ...
 $kodeHTML = bacaHTML('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/0'); //statisik di ganti dengan nama desa
 ...
 $kodeHTML = empat('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/0'); //statistik di ganti dengan nama desa
