<?php
              ...
              include "model/kecamatan/mantang/index5.php";
          ?>
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/1');
