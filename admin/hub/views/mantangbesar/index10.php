<?php
              ...
              include "model/kecamatan/mantang/index10.php";
          ?>
...
<label class="section-title">Desa Mantang Besar</label>
 ...
 $kodeHTML = bacaHTML('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://mantangbesar.simdes-bintan.id/index.php/first/statistik/502');
