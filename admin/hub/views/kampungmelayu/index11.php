...
<label class="section-title">Desa Kampung Melayu</label>
 ...
 $kodeHTML = bacaHTML('http://kampungmelayu.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://kampungmelayu.simdes-bintan.id/index.php/first/statistik/503');
