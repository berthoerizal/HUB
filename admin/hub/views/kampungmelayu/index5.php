...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://kampungmelayu.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://kampungmelayu.simdes-bintan.id/index.php/first/statistik/1');
