...
<label class="section-title">Desa Dendun</label> 
 ...
 $kodeHTML = bacaHTML('http://dendun.simdes-bintan.id/index.php/first/statistik/0'); //statisik di ganti dengan nama desa
 ...
 $kodeHTML = empat('http://dendun.simdes-bintan.id/index.php/first/statistik/0'); //statistik di ganti dengan nama desa
