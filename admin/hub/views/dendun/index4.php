...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://dendun.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://dendun.simdes-bintan.id/index.php/first/statistik/14/0');
