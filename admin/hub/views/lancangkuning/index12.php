<?php
              ...
              include "model/kecamatan/bintanutara/index12.php";
          ?>
...
<label class="section-title">Desa Lancang Kuning</label>
 ...
 $kodeHTML = bacaHTML('http://lancangkuning.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://lancangkuning.simdes-bintan.id/index.php/first/statistik/504');
