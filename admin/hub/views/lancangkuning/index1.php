        <?php
              include "model/header/header_bintan_utara.php";
              include "model/kecamatan/null/index1.php";
              include "model/kecamatan/bintanutara/index1.php";
          ?>

            <label class="section-title">Desa Lancang Kuning</label>
              ...
              <div class="file-group">
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <h6 class="tx-inverse tx-normal">Lancang Kuning</h6>
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">Cholili Bunyani</h6>
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">Jalan Raya Tanjung Uban-Tanjungpinang km.83</h6>
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">29152</h6>
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">-_____<sup></sup></h6>
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="media-list mg-t-25">
                  <div class="media">
                    ...
                    <div class="media-body mg-l-15 mg-t-4">
                      ...
                      <a href="http://lancangkuning.simdes-bintan.id/" class="d-block">lancangkuning.simdes-bintan.id</a>
                    </div><!-- media-body -->
                  </div><!-- media -->
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-4">
                      ...
                      <span class="d-block">________</span>
                    </div><!-- media-body -->
                  </div><!-- media -->
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-4">
                     ...
                     <a href="mailto:lancangkuninggemilang@gmail.com"><span class="d-block">lancangkuninggemilang@gmail.com</span></a> 
                    </div><!-- media-body -->
                  </div><!-- media -->
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-2">
                      ...
                      <a href="https://web.facebook.com/lancangkuning.gemilang.1" class="d-block">LancangKuning Gemilang</a>
                    </div><!-- media-body -->
                  </div><!-- media -->
                </div><!-- media-list -->
                ...
                <div class="slim-card-title">Contact</div>
                  ...
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-2">
                      ...
                      <a href="https://api.whatsapp.com/send?phone=6281378712743&text=Halo%20?" class="d-block">+6281378712743</a>
                    </div><!-- media-body -->
                  </div><!-- media -->
                </div><!-- media-list -->
              </div><!-- card -->
