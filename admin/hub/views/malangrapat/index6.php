...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://malangrapat.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://malangrapat.simdes-bintan.id/index.php/first/statistik/3');
