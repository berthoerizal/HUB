...
$kodeHTML = bacaHTML('http://malangrapat.simdes-bintan.id/index.php/first/statistik/13');
...
$kodeHTML = empat('http://malangrapat.simdes-bintan.id/index.php/first/statistik/13');
