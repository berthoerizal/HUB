...
<label class="section-title">Desa Malang Rapat</label>
 ...
 $kodeHTML = bacaHTML('http://malangrapat.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://malangrapat.simdes-bintan.id/index.php/first/statistik/503');
