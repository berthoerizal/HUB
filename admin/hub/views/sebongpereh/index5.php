...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/1');
