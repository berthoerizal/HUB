...
<label class="section-title">Desa Sebong Pereh</label>
 ...
 $kodeHTML = bacaHTML('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/504');
