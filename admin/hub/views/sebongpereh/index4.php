...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://sebongpereh.simdes-bintan.id/index.php/first/statistik/14/0');
