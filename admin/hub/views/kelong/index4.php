...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://kelong.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://kelong.simdes-bintan.id/index.php/first/statistik/14/0');
