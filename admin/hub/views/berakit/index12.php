...
<label class="section-title">Desa Berakit</label>
 ...
 $kodeHTML = bacaHTML('http://berakit.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://berakit.simdes-bintan.id/index.php/first/statistik/504');
