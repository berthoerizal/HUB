...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://berakit.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://berakit.simdes-bintan.id/index.php/first/statistik/14/0');
