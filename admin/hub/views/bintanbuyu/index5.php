...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/1');
