...
<label class="section-title">Desa Bintan Buyu</label>
 ...
 $kodeHTML = bacaHTML('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/503');
