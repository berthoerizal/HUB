...
$kodeHTML = bacaHTML('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/13');
...
$kodeHTML = empat('http://bintanbuyu.simdes-bintan.id/index.php/first/statistik/13');
