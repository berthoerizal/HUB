...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://batulepuk.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://batulepuk.simdes-bintan.id/index.php/first/statistik/3');
