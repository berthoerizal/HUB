...
<label class="section-title">Desa Batu Lepuk</label>
 ...
 $kodeHTML = bacaHTML('http://batulepuk.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://batulepuk.simdes-bintan.id/index.php/first/statistik/502');
