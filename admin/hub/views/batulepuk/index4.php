...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://batulepuk.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://batulepuk.simdes-bintan.id/index.php/first/statistik/14/0');
