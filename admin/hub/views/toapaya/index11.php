...
<label class="section-title">Desa Toapaya</label>
 ...
 $kodeHTML = bacaHTML('http://toapaya.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://toapaya.simdes-bintan.id/index.php/first/statistik/503');
