...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://toapaya.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://toapaya.simdes-bintan.id/index.php/first/statistik/14/0');
