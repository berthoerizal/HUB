...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/3');
