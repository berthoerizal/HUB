...
<label class="section-title">Desa Sebong Lagoi</label>
 ...
 $kodeHTML = bacaHTML('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/504');
