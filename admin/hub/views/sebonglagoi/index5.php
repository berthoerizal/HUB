...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://sebonglagoi.simdes-bintan.id/index.php/first/statistik/1');
