      <?php
              ...
              include "model/kecamatan/gunungkijang/index13.php";
          ?>
...
<label class="section-title">Desa Gunung Kijang</label>
 ...
 $kodeHTML = bacaHTML('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/505');
 ...
 $kodeHTML = empat('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/505');
