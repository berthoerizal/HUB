...
<label class="section-title">Desa Gunung Kijang</label>
 ...
 $kodeHTML = bacaHTML('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/504');
