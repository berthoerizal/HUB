              ...
              <div class="file-group">
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <h6 class="tx-inverse tx-normal">Gunung Kijang</h6>  <!-- ganti nama desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">LA Nade</h6>  <!-- ganti nama desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">Jl. Agro No.5</h6> <!-- ganti alamat kantor desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">29155</h6>  <!-- kode pos -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">71,2 km<sup>2</sup></h6>  <!-- isi luas daratan , tambahkan pangkat pada sub untuk meter persegi (jika ada) -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="media-list mg-t-25">
                  <div class="media">
                    ...
                    <div class="media-body mg-l-15 mg-t-4">
                      ...
                      <a href="http://gunungkijang.simdes-bintan.id/" class="d-block">gunungkijang.simdes-bintan.id</a>  <!-- ganti nama website desa -->
                    </div><!-- media-body -->
                  </div><!-- media -->
