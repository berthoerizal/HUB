<?php
              ...
              include "model/kecamatan/gunungkijang/index10.php";
          ?>
...
<label class="section-title">Desa Busung</label>
 ...
 $kodeHTML = bacaHTML('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/502');
