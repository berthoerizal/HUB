<?php
              ...
              include "model/kecamatan/gunungkijang/index11.php";
          ?>
<!-- data penerima PKH-->
...
<label class="section-title">Desa Gunung Kijang</label>
 ...
 $kodeHTML = bacaHTML('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://gunungkijang.simdes-bintan.id/index.php/first/statistik/503');
