              ...
              <div class="file-group">
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <h6 class="tx-inverse tx-normal">Toapaya Utara</h6>  <!-- ganti nama desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">Sayet</h6>  <!-- ganti nama desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="file-item">
                  <div class="row no-gutters wd-100p">
                    ...
                    <div class="col-9 col-md-6 tx-right tx-sm-left">
                    <h6 class="tx-inverse tx-normal">Jl.Tg.Uban Km. 40</h6> <!-- ganti alamat kantor desa -->
                    </div>
                  </div><!-- row -->
                </div><!-- file-item -->
                ...
                <div class="media-list mg-t-25">
                  <div class="media">
                    ...
                    <div class="media-body mg-l-15 mg-t-4">
                      ...
                      <a href="http://toapayautara.simdes-bintan.id/" class="d-block">toapayautara.simdes-bintan.id</a>  <!-- ganti nama website desa -->
                    </div><!-- media-body -->
                  </div><!-- media -->
                  ...
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-2">
                      ...
                      <a href="https://facebook.com/toapayautara.kknkb2016" class="d-block">Desa Toapaya Utara</a>
                    </div><!-- media-body -->
                  </div><!-- media -->
                </div><!-- media-list -->
                ...
                <div class="slim-card-title">Contact</div>
                  <div class="media mg-t-25">
                    ...
                    <div class="media-body mg-l-15 mg-t-2">
                      ...
                      <a href="#" class="d-block">-</a>  <!-- ganti dengan nomor kades pada "API & tampilan" -->
                    </div><!-- media-body -->
                  </div><!-- media -->
                </div><!-- media-list -->
              </div><!-- card -->
