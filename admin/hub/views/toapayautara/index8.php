...
$kodeHTML = bacaHTML('http://toapayautara.simdes-bintan.id/index.php/first/statistik/13');
...
$kodeHTML = empat('http://toapayautara.simdes-bintan.id/index.php/first/statistik/13');
