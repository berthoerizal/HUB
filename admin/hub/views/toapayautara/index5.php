...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://toapayautara.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://toapayautara.simdes-bintan.id/index.php/first/statistik/1');
