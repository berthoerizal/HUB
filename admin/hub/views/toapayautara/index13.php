...
<label class="section-title">Desa Toapaya Utara</label>
 ...
 $kodeHTML = bacaHTML('http://toapayautara.simdes-bintan.id/index.php/first/statistik/505');
 ...
 $kodeHTML = empat('http://toapayautara.simdes-bintan.id/index.php/first/statistik/505');
