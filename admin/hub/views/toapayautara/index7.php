      ...
      <p class="mg-b-20 mg-sm-b-40">Data Jenis Kelamin</p>
            <div class="row">
              ...
              <?php
                ...
                $kodeHTML = bacaHTML('http://toapayautara.simdes-bintan.id/index.php/first/statistik/4');
...
$kodeHTML = empat('http://toapayautara.simdes-bintan.id/index.php/first/statistik/4');
