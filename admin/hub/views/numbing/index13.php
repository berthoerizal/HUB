<?php
              ...
              include "model/kecamatan/bintanpesisir/index13.php";
          ?>
...
<label class="section-title">Desa Numbing</label>
 ...
 $kodeHTML = bacaHTML('http://numbing.simdes-bintan.id/index.php/first/statistik/505');
 ...
 $kodeHTML = empat('http://numbing.simdes-bintan.id/index.php/first/statistik/505');
