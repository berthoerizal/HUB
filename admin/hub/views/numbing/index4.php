...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://numbing.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://numbing.simdes-bintan.id/index.php/first/statistik/14/0');
