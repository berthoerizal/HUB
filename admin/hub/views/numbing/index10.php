...
<label class="section-title">Desa Numbing</label>
 ...
 $kodeHTML = bacaHTML('http://numbing.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://numbing.simdes-bintan.id/index.php/first/statistik/502');
