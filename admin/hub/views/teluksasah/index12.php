...
<label class="section-title">Desa Teluk Sasah</label>
 ...
 $kodeHTML = bacaHTML('http://teluksasah.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://teluksasah.simdes-bintan.id/index.php/first/statistik/504');
