          ...
          <?php
              ...
              include "model/kecamatan/serikualalobam/index2.php";
          ?>

    <label class="section-title">Desa Kuala Teluk Sasah</label>
...
$kodeHTML = bacaHTML('http://teluksasah.simdes-bintan.id/index.php/first/wilayah');
