 ...
 $kodeHTML = bacaHTML('http://teluksasah.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://teluksasah.simdes-bintan.id/index.php/first/statistik/3');
