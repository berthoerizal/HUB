      ...
      <p class="mg-b-20 mg-sm-b-40">Data Jenis Kelamin</p>
            <div class="row">
              ...
              <?php
                ...
                $kodeHTML = bacaHTML('http://sribintan.simdes-bintan.id/index.php/first/statistik/4');
...
$kodeHTML = empat('http://sribintan.simdes-bintan.id/index.php/first/statistik/4');
