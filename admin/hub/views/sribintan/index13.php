...
<label class="section-title">Desa Sri Bintan</label>
 ...
 $kodeHTML = bacaHTML('http://sribintan.simdes-bintan.id/index.php/first/statistik/505');
 ...
 $kodeHTML = empat('http://sribintan.simdes-bintan.id/index.php/first/statistik/505');
