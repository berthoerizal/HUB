...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sribintan.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://sribintan.simdes-bintan.id/index.php/first/statistik/1');
