...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://sribintan.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://sribintan.simdes-bintan.id/index.php/first/statistik/3');
