<?php
              ...
              include "model/kecamatan/bintanpesisir/index9.php";
          ?>
...
<label class="section-title">Desa Air Gelubi</label>
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/501');
