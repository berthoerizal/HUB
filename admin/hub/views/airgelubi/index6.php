<?php
              ...
              include "model/kecamatan/bintanpesisir/index6.php";
          ?>
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/3');
