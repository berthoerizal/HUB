<?php
              ...
              include "model/kecamatan/bintanpesisir/index12.php";
          ?>
...
<label class="section-title">Desa Air Gelubi</label>
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/504');
