<?php
              ...
              include "model/kecamatan/bintanpesisir/index11.php";
          ?>
<!-- data penerima PKH-->
...
<label class="section-title">Desa Air Gelubi</label>
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/503');
