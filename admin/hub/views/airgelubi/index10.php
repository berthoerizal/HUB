<?php
              ...
              include "model/kecamatan/bintanpesisir/index10.php";
          ?>
...
<label class="section-title">Desa Air Gelubi</label>
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/502');
