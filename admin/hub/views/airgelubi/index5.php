...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://airgelubi.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://airgelubi.simdes-bintan.id/index.php/first/statistik/1');
