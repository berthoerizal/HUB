...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://telukbakau.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://telukbakau.simdes-bintan.id/index.php/first/statistik/3');
