...
<label class="section-title">Desa Teluk Bakau</label>
 ...
 $kodeHTML = bacaHTML('http://telukbakau.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://telukbakau.simdes-bintan.id/index.php/first/statistik/502');
