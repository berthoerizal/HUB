<?php
              ...
              include "model/kecamatan/telukbintan/index11.php";
          ?>
<!-- data penerima PKH-->
...
<label class="section-title">Desa Tembeling</label>
 ...
 $kodeHTML = bacaHTML('http://tembeling.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://tembeling.simdes-bintan.id/index.php/first/statistik/503');
