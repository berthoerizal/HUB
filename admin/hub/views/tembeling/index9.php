<?php
              ...
              include "model/kecamatan/telukbintan/index9.php";
          ?>
...
<label class="section-title">Desa Tembeling</label>
 ...
 $kodeHTML = bacaHTML('http://tembeling.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://tembeling.simdes-bintan.id/index.php/first/statistik/501');
