<?php
              ...
              include "model/kecamatan/telukbintan/index10.php";
          ?>
...
<label class="section-title">Desa Tembeling</label>
 ...
 $kodeHTML = bacaHTML('http://tembeling.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://tembeling.simdes-bintan.id/index.php/first/statistik/502');
