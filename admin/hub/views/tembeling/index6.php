...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://tembeling.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://tembeling.simdes-bintan.id/index.php/first/statistik/3');
