...
<label class="section-title">Desa Tembeling</label>
 ...
 $kodeHTML = bacaHTML('http://tembeling.simdes-bintan.id/index.php/first/statistik/504');
 ...
 $kodeHTML = empat('http://tembeling.simdes-bintan.id/index.php/first/statistik/504');
