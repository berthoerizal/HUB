...
<label class="section-title">Desa Pangkil</label>
 ...
 $kodeHTML = bacaHTML('http://pangkil.simdes-bintan.id/index.php/first/statistik/503');
 ...
 $kodeHTML = empat('http://pangkil.simdes-bintan.id/index.php/first/statistik/503');
