...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://pangkil.simdes-bintan.id/index.php/first/statistik/14/0');
 ...
 $kodeHTML = empat('http://pangkil.simdes-bintan.id/index.php/first/statistik/14/0');
