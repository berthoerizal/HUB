...
<label class="section-title">Desa Kampung Hilir</label>
 ...
 $kodeHTML = bacaHTML('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/501');
 ...
 $kodeHTML = empat('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/501');
