...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/3');
