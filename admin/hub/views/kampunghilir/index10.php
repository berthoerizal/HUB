...
<label class="section-title">Desa Kampung Hilir</label>
 ...
 $kodeHTML = bacaHTML('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/502');
