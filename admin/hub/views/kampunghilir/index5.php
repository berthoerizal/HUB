...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/1');
 ...
 $kodeHTML = empat('http://kampunghilir.simdes-bintan.id/index.php/first/statistik/1');
