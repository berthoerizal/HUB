...
<!-- <div class="section-wrapper"> -->
 ...
 $kodeHTML = bacaHTML('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/3');
 ...
 $kodeHTML = empat('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/3');
