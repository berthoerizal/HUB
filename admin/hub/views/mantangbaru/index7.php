      ...
      <p class="mg-b-20 mg-sm-b-40">Data Jenis Kelamin</p>
            <div class="row">
              ...
              <?php
                ...
                $kodeHTML = bacaHTML('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/4');
...
$kodeHTML = empat('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/4');
