...
<label class="section-title">Desa Mantang Baru</label>
 ...
 $kodeHTML = bacaHTML('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/502');
 ...
 $kodeHTML = empat('http://mantangbaru.simdes-bintan.id/index.php/first/statistik/502');
