...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-profil-desa">Desa Toapaya</option>
        <option value="toapayautara-profil-desa">Desa Toapaya Utara </option>
        <option value="toapayaselatan-profil-desa">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
