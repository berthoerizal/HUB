...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-data-jenis-kelamin">Desa Toapaya</option>
        <option value="toapayautara-data-jenis-kelamin">Desa Toapaya Utara </option>
        <option value="toapayaselatan-data-jenis-kelamin">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
