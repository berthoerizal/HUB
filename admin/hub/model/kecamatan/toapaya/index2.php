...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-wilayah-administratif">Desa Toapaya</option>
        <option value="toapayautara-wilayah-administratif">Desa Toapaya Utara </option>
        <option value="toapayaselatan-wilayah-administratif">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
