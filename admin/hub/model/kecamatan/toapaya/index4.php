...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-data-pendidikan-ditempuh">Desa Toapaya</option>
        <option value="toapayautara-data-pendidikan-ditempuh">Desa Toapaya Utara </option>
        <option value="toapayaselatan-data-pendidikan-ditempuh">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
