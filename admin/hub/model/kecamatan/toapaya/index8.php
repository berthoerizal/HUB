...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-data-warga-negara">Desa Toapaya</option>
        <option value="toapayautara-data-warga-negara">Desa Toapaya Utara </option>
        <option value="toapayaselatan-data-warga-negara">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
