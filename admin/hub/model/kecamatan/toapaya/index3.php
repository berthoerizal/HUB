...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-data-pendidikan-dalam-kk">Desa Toapaya</option>
        <option value="toapayautara-data-pendidikan-dalam-kk">Desa Toapaya Utara </option>
        <option value="toapayaselatan-data-pendidikan-dalam-kk">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
