...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-pkh">Desa Toapaya</option>
        <option value="toapayautara-pkh">Desa Toapaya Utara </option>
        <option value="toapayaselatan-pkh">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
