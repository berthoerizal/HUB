...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-penerima-raskin">Desa Toapaya</option>
        <option value="toapayautara-penerima-raskin">Desa Toapaya Utara </option>
        <option value="toapayaselatan-penerima-raskin">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
