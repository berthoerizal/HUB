...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-bedahrumah">Desa Toapaya</option>
        <option value="toapayautara-bedahrumah">Desa Toapaya Utara </option>
        <option value="toapayaselatan-bedahrumah">Desa Toapaya Selatan</option>
    </select>
