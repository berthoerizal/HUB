...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-blsm">Desa Toapaya</option>
        <option value="toapayautara-blsm">Desa Toapaya Utara </option>
        <option value="toapayaselatan-blsm">Desa Toapaya Selatan</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
