...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="toapaya-jamkesmas">Desa Toapaya</option>
        <option value="toapayautara-jamkesmas">Desa Toapaya Utara </option>
        <option value="toapayaselatan-jamkesmas">Desa Toapaya Selatan</option>
