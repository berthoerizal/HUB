...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
       ...
       <option value="mantangbaru-data-pendidikan-ditempuh">Desa Mantang Baru</option>
        <option value="mantangbesar-data-pendidikan-ditempuh">Desa Mantang Besar </option>
        <option value="mantanglama-data-pendidikan-ditempuh">Desa Mantang Lama</option>
        <option value="dendun-data-pendidikan-ditempuh">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
