...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-bedahrumah">Desa Mantang Baru</option>
        <option value="mantangbesar-bedahrumah">Desa Mantang Besar </option>
        <option value="mantanglama-bedahrumah">Desa Mantang Lama</option>
        <option value="dendun-bedahrumah">Desa Dendun</option>
    </select>
