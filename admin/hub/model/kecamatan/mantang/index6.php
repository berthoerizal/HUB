...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-data-agama">Desa Mantang Baru</option>
        <option value="mantangbesar-data-agama">Desa Mantang Besar </option>
        <option value="mantanglama-data-agama">Desa Mantang Lama</option>
        <option value="dendun-data-agama">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
