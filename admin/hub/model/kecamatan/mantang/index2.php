...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-wilayah-administratif">Desa Mantang Baru</option>
        <option value="mantangbesar-wilayah-administratif">Desa Mantang Besar </option>
        <option value="mantanglama-wilayah-administratif">Desa Mantang Lama</option>
        <option value="dendun-wilayah-administratif">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
