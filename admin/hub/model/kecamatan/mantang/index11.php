...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-pkh">Desa Mantang Baru</option>
        <option value="mantangbesar-pkh">Desa Mantang Besar </option>
        <option value="mantanglama-pkh">Desa Mantang Lama</option>
        <option value="dendun-pkh">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
