...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-data-jenis-kelamin">Desa Mantang Baru</option>
        <option value="mantangbesar-data-jenis-kelamin">Desa Mantang Besar </option>
        <option value="mantanglama-data-jenis-kelamin">Desa Mantang Lama</option>
        <option value="dendun-data-jenis-kelamin">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
