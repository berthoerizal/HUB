...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-jamkesmas">Desa Mantang Baru</option>
        <option value="mantangbesar-jamkesmas">Desa Mantang Besar </option>
        <option value="mantanglama-jamkesmas">Desa Mantang Lama</option>
        <option value="dendun-jamkesmas">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
