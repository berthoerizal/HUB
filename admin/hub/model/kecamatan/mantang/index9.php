...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-penerima-raskin">Desa Mantang Baru</option>
        <option value="mantangbesar-penerima-raskin">Desa Mantang Besar </option>
        <option value="mantanglama-penerima-raskin">Desa Mantang Lama</option>
        <option value="dendun-penerima-raskin">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
