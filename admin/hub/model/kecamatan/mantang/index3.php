...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-data-pendidikan-dalam-kk">Desa Mantang Baru</option>
        <option value="mantangbesar-data-pendidikan-dalam-kk">Desa Mantang Besar </option>
        <option value="mantanglama-data-pendidikan-dalam-kk">Desa Mantang Lama</option>
        <option value="dendun-data-pendidikan-dalam-kk">Desa Dendun</option>n>
    </select>
    <noscript>
<input type='submit'>
</noscript>
