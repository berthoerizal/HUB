...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-data-pekerjaan">Desa Mantang Baru</option>
        <option value="mantangbesar-data-pekerjaan">Desa Mantang Besar </option>
        <option value="mantanglama-data-pekerjaan">Desa Mantang Lama</option>
        <option value="dendun-data-pekerjaan">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
