...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-blsm">Desa Mantang Baru</option>
        <option value="mantangbesar-blsm">Desa Mantang Besar </option>
        <option value="mantanglama-blsm">Desa Mantang Lama</option>
        <option value="dendun-blsm">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
