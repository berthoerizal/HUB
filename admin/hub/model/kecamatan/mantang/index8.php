...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="mantangbaru-data-warga-negara">Desa Mantang Baru</option>
        <option value="mantangbesar-data-warga-negara">Desa Mantang Besar </option>
        <option value="mantanglama-data-warga-negara">Desa Mantang Lama</option>
        <option value="dendun-data-warga-negara">Desa Dendun</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
