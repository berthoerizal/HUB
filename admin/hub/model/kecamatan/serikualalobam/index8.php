...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-data-warga-negara">Desa Kuala Sempang</option>
        <option value="busung-data-warga-negara">Desa Busung</option>
        <option value="teluksasah-data-warga-negara">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
