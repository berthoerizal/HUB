...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-wilayah-administratif">Desa Kuala Sempang</option>
        <option value="busung-wilayah-administratif">Desa Busung</option>
        <option value="teluksasah-wilayah-administratif">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
