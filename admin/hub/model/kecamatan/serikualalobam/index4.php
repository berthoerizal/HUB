...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-data-pendidikan-ditempuh">Desa Kuala Sempang</option>
        <option value="busung-data-pendidikan-ditempuh">Desa Busung</option>
        <option value="teluksasah-data-pendidikan-ditempuh">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
