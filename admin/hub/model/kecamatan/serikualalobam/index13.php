...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-jamkesmas">Desa Kuala Sempang</option>
        <option value="busung-jamkesmas">Desa Busung</option>
        <option value="teluksasah-jamkesmas">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
