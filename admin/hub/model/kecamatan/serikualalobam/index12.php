...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-bedahrumah">Desa Kuala Sempang</option>
        <option value="busung-bedahrumah">Desa Busung</option>
        <option value="teluksasah-bedahrumah">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
