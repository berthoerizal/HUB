...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-data-jenis-kelamin">Desa Kuala Sempang</option>
        <option value="busung-data-jenis-kelamin">Desa Busung</option>
        <option value="teluksasah-data-jenis-kelamin">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
