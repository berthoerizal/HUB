...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-penerima-raskin">Desa Kuala Sempang</option>
        <option value="busung-penerima-raskin">Desa Busung</option>
        <option value="teluksasah-penerima-raskin">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
