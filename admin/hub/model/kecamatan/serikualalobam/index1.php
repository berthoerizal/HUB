...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-profil-desa">Desa Kuala Sempang</option>
        <option value="busung-profil-desa">Desa Busung</option>
        <option value="teluksasah-profil-desa">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
