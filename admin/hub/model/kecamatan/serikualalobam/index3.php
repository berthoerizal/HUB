...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-data-pendidikan-dalam-kk">Desa Kuala Sempang</option>
        <option value="busung-data-pendidikan-dalam-kk">Desa Busung</option>
        <option value="teluksasah-data-pendidikan-dalam-kk">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
