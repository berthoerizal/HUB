...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-blsm">Desa Kuala Sempang</option>
        <option value="busung-blsm">Desa Busung</option>
        <option value="teluksasah-blsm">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
