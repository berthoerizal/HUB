...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kualasempang-data-agama">Desa Kuala Sempang</option>
        <option value="busung-data-agama">Desa Busung</option>
        <option value="teluksasah-data-agama">Desa Teluk Sasah</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
