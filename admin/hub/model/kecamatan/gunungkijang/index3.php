...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-data-pendidikan-dalam-kk">Desa Gunung Kijang</option>
        <option value="malangrapat-data-pendidikan-dalam-kk">Malang Rapat</option>
        <option value="telukbakau-data-pendidikan-dalam-kk">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
