...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-jamkesmas">Desa Gunung Kijang</option>
        <option value="malangrapat-jamkesmas">Desa Malang Rapat</option>
        <option value="telukbakau-jamkesmas">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
