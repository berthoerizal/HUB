...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-wilayah-administratif">Desa Gunung Kijang</option>
        <option value="malangrapat-wilayah-administratif">Desa Malang Rapat</option>
        <option value="telukbakau-wilayah-administratif">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
