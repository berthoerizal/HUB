...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-penerima-raskin">Desa Gunung Kijang</option>
        <option value="malangrapat-penerima-raskin">Desa Malang Rapat</option>
        <option value="telukbakau-penerima-raskin">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
