...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-data-agama">Desa Gunung Kijang</option>
        <option value="malangrapat-data-agama">Desa Malang Rapat</option>
        <option value="telukbakau-data-agama">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
