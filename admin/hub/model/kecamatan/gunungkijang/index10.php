...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-blsm">Desa Gunung Kijang</option>
        <option value="malangrapat-blsm">Desa Malang Rapat</option>
        <option value="telukbakau-blsm">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
