...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-data-warga-negara">Desa Gunung Kijang</option>
        <option value="malangrapat-data-warga-negara">Desa Malang Rapat</option>
        <option value="telukbakau-data-warga-negara">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
