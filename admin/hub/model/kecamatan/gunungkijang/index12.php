...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-bedahrumah">Desa Gunung Kijang</option>
        <option value="busung-bedahrumah">Desa Malang Rapat</option>
        <option value="telukbakau-bedahrumah">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
