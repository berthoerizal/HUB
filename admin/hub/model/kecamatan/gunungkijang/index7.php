...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-data-jenis-kelamin">Desa Gunung Kijang</option>
        <option value="malangrapat-data-jenis-kelamin">Desa Malang Rapat</option>
        <option value="telukbakau-data-jenis-kelamin">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
