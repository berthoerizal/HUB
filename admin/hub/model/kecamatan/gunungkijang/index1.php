...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-profil-desa">Desa Gunung Kijang</option>
        <option value="malangrapat-profil-desa">Desa Malang Rapat</option>
        <option value="telukbakau-profil-desa">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
