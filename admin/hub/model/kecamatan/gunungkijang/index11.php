...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="gunungkijang-pkh">Desa Gunung Kijang</option>
        <option value="malangrapat-pkh">Desa Malang Rapat</option>
        <option value="telukbakau-pkh">Desa Teluk Bakau</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
