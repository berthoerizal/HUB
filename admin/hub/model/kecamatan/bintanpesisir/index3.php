...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-pendidikan-dalam-kk">Desa Kelong</option>
        <option value="airgelubi-data-pendidikan-dalam-kk">Desa Air Gelubi </option>
        <option value="mapur-data-pendidikan-dalam-kk">Desa Mapur</option>
        <option value="numbing-data-pendidikan-dalam-kk">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
