...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-pekerjaan">Desa Kelong</option>
        <option value="airgelubi-data-pekerjaan">Desa Air Gelubi </option>
        <option value="mapur-data-pekerjaan">Desa Mapur</option>
        <option value="numbing-data-pekerjaan">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
