...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-pkh">Desa Kelong</option>
        <option value="airgelubi-pkh">Desa Air Gelubi </option>
        <option value="mapur-pkh">Desa Mapur</option>
        <option value="numbing-pkh">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
