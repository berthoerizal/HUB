...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-warga-negara">Desa Kelong</option>
        <option value="airgelubi-data-warga-negara">Desa Air Gelubi </option>
        <option value="mapur-data-warga-negara">Desa Mapur</option>
        <option value="numbing-data-warga-negara">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
