...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-bedahrumah">Desa Kelong</option>
        <option value="airgelubi-bedahrumah">Desa Air Gelubi </option>
        <option value="mapur-bedahrumah">Desa Mapur</option>
        <option value="numbing-bedahrumah">Desa numbing</option>
    </select>
