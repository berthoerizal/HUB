...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-pendidikan-ditempuh">Desa Kelong</option>
        <option value="airgelubi-data-pendidikan-ditempuh">Desa Air Gelubi </option>
        <option value="mapur-data-pendidikan-ditempuh">Desa Mapur</option>
        <option value="numbing-data-pendidikan-ditempuh">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
