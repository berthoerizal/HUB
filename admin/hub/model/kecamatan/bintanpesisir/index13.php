...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-jamkesmas">Desa Kelong</option>
        <option value="airgelubi-jamkesmas">Desa Air Gelubi </option>
        <option value="mapur-jamkesmas">Desa Mapur</option>
        <option value="numbing-jamkesmas">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
