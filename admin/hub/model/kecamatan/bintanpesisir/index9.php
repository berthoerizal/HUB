...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-penerima-raskin">Desa Kelong</option>
        <option value="airgelubi-penerima-raskin">Desa Air Gelubi </option>
        <option value="mapur-penerima-raskin">Desa Mapur</option>
        <option value="numbing-penerima-raskin">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
