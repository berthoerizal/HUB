...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-agama">Desa Kelong</option>
        <option value="airgelubi-data-agama">Desa Air Gelubi </option>
        <option value="mapur-data-agama">Desa Mapur</option>
        <option value="numbing-data-agama">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
