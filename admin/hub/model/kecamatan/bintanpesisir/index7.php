...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-data-jenis-kelamin">Desa Kelong</option>
        <option value="airgelubi-data-jenis-kelamin">Desa Air Gelubi </option>
        <option value="mapur-data-jenis-kelamin">Desa Mapur</option>
        <option value="numbing-data-jenis-kelamin">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
