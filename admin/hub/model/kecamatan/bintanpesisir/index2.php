...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-wilayah-administratif">Desa Kelong</option>
        <option value="airgelubi-wilayah-administratif">Desa Air Gelubi </option>
        <option value="mapur-wilayah-administratif">Desa Mapur</option>
        <option value="numbing-wilayah-administratif">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
