...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="kelong-profil-desa">Desa Kelong</option>
        <option value="airgelubi-profil-desa">Desa Air Gelubi </option>
        <option value="mapur-profil-desa">Desa Mapur</option>
        <option value="numbing-profil-desa">Desa numbing</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
