...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="berakit-pkh">Desa Berakit</option>
        <option value="pengudang-pkh">Desa Pengudang</option>
        <option value="sribintan-pkh">Desa Sri Bintan</option>
        <option value="ekanganculai-pkh">Desa Ekang Anculai</option>
        <option value="sebonglagoi-pkh">Desa Sebong Lagoi</option>
        <option value="sebongpereh-pkh">Desa Sebong Pereh</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
