...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-pkh">Desa Bintan Buyu</option>
        <option value="tembeling-pkh">Desa Tembeling </option>
        <option value="penaga-pkh">Desa Penaga</option>
        <option value="pengujan-pkh">Desa Pengujan </option>
        <option value="pangkil-pkh">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
