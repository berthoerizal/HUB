...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-bedahrumah">Desa Bintan Buyu</option>
        <option value="tembeling-bedahrumah">Desa Tembeling </option>
        <option value="penaga-bedahrumah">Desa Penaga</option>
        <option value="pengujan-bedahrumah">Desa Pengujan </option>
        <option value="pangkil-bedahrumah">Desa Pangkil</option>
    </select>
