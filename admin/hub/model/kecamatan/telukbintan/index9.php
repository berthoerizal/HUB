...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-penerima-raskin">Desa Bintan Buyu</option>
        <option value="tembeling-penerima-raskin">Desa Tembeling </option>
        <option value="penaga-penerima-raskin">Desa Penaga</option>
        <option value="pengujan-penerima-raskin">Desa Pengujan </option>
        <option value="pangkil-penerima-raskin">Desa Pangkil</option>
