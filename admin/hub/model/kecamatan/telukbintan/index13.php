...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-jamkesmas">Desa Bintan Buyu</option>
        <option value="tembeling-jamkesmas">Desa Tembeling </option>
        <option value="penaga-jamkesmas">Desa Penaga</option>
        <option value="pengujan-jamkesmas">Desa Pengujan </option>
        <option value="pangkil-jamkesmas">Desa Pangkil</option>
