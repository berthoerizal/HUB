...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-data-warga-negara">Desa Bintan Buyu</option>
        <option value="tembeling-data-warga-negara">Desa Tembeling </option>
        <option value="penaga-data-warga-negara">Desa Penaga</option>
        <option value="pengujan-data-warga-negara">Desa Pengujan </option>
        <option value="pangkil-data-warga-negara">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
