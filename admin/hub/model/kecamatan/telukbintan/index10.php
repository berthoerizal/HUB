...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-blsm">Desa Bintan Buyu</option>
        <option value="tembeling-blsm">Desa Tembeling </option>
        <option value="penaga-blsm">Desa Penaga</option>
        <option value="pengujan-blsm">Desa Pengujan </option>
        <option value="pangkil-blsm">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
