...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-data-pekerjaan">Desa Bintan Buyu</option>
        <option value="tembeling-data-pekerjaan">Desa Tembeling </option>
        <option value="penaga-data-pekerjaan">Desa Penaga</option>
        <option value="pengujan-data-pekerjaan">Desa Pengujan </option>
        <option value="pangkil-data-pekerjaan">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
