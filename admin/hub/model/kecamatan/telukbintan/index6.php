...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-data-agama">Desa Bintan Buyu</option>
        <option value="tembeling-data-agama">Desa Tembeling </option>
        <option value="penaga-data-agama">Desa Penaga</option>
        <option value="pengujan-data-agama">Desa Pengujan </option>
        <option value="pangkil-data-agama">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
