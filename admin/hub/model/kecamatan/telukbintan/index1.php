...
<div class="section-wrapper">
  ...
  <div class="row">
    ...
    <select name="catid" class="form-control"  id="catid" onChange="doReload(this.value);">
        ...
        <option value="bintanbuyu-profil-desa">Desa Bintan Buyu</option>
        <option value="tembeling-profil-desa">Desa Tembeling</option>
        <option value="penaga-profil-desa">Desa Penaga</option>
        <option value="pengujan-profil-desa">Desa Pengujan</option>
        <option value="pangkil-profil-desa">Desa Pangkil</option>
    </select>
    <noscript>
<input type='submit'>
</noscript>
